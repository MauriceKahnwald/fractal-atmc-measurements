...
logger = logging.getLogger("atmc_analysis_feature_extraction_task")
...
@validate_call
def atmc_analysis_feature_extraction_task(
    *,
    ...
    https://github.com/MauriceKahnwald/fractal-atmc-measurements/fractal-tasks-utils
...
if __name__ == "__main__":
    ...
    run_fractal_task(task_function=atmc_analysis_feature_extraction_task)
